...
- [Data Engineering](#data-engineering)
  ...
  - [Python for Data Engineering](#python-for-data-engineering)
    - [Essential Python patterns for data work](#essential-python-patterns-for-data-work)
    - [Working with files](#working-with-files)
    - [Type hints in data pipelines](#type-hints-in-data-pipelines)
...
📖 **Full Python reference:** [Python Language Notes](../language/Python.ipynb)
