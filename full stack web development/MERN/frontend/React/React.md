...
- [Immutable State Updates, Immer & Sharing State](#immutable-state-updates-immer--sharing-state)
...
- [React.memo](#reactmemo)
  ...
  - [The second argument — `arePropsEqual`](#the-second-argument--arepropsequal)
  - [Why shallow comparison fails with objects and functions](#why-shallow-comparison-fails-with-objects-and-functions)
  - [The trio: memo + useMemo + useCallback](#the-trio-memo--usememo--usecallback)
...
- [**What happens when we use callback function as props?**](#what-happens-when-we-use-callback-function-as-props)
  ...
  - [Summary](#summary)
- [Redux & Unidirectional Data Flow](#redux--unidirectional-data-flow)
- [Conclusion](#conclusion)
- [Memoizing](#memoizing)
- [React Forms](#react-forms)
- [Connecting to a Backend & Data Fetching](#connecting-to-a-backend--data-fetching)
...
When Redux is used in a React app, the unidirectional data flow principle is preserved — components **dispatch actions** to a centralised store, **reducers** produce new state, and updated state flows back down to components via `useSelector`.

Key concepts: Store · Actions · Reducers · Dispatch · Selectors · Middleware

→ See [Redux/Redux.md](../Redux/Redux.md) for installation, Redux Toolkit, DUCKS pattern, custom hooks, and real-world examples  
→ See [Redux/ReduxPatterns.md](../Redux/ReduxPatterns.md) for advanced patterns (Classic, DUCKS, RTK, Entity Adapter, Sagas)
